function CBonusPanel(){
    ...
    this.show = function(iNumBonusItem){
        ...
        _aPrizePrizes[0].text = _aBonusValue[0] + "$";
        _aPrizePrizes[1].text = _aBonusValue[1] + "$";
        _aPrizePrizes[2].text = _aBonusValue[2] + "$";
    ...
    this.endBonus = function(iIndex){
        //SHOW PRIZE WON
        _oWinText = new CScoreText("+"+_iBonusMoney,_aWinPos[iIndex].x ,_aWinPos[iIndex].y);
